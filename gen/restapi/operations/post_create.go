...
type PostCreateHandlerFunc func(PostCreateParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PostCreateHandlerFunc) Handle(params PostCreateParams) middleware.Responder {
	return fn(params)
}

// PostCreateHandler interface for that can handle valid post create params
type PostCreateHandler interface {
	Handle(PostCreateParams) middleware.Responder
}
...
/*PostCreate swagger:route POST /create postCreate
